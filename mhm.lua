...
local Window = OrionLib:MakeWindow({Name = "Miner's Haven Eternity by Mizuki#7632", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
...
local Section1f = Tab5:AddSection({
	Name = "Description"
})
...
Section1f:AddParagraph("Made By Lcopium#1131","I copied Lcopium#1131 mhm script but i made a few changes")
